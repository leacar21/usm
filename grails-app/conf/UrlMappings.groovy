...
class UrlMappings {
	...
	static mappings = {
		...
		"/systems/$idSystem/accessTypes"(controller:"system", action: "addAccessType", method: "POST")
		"/systems/$idSystem/accessTypes/$idAccessType"(controller:"system", action: "quitAccessType", method: "DELETE")
	}
}
